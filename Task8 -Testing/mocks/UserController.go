...
func (_m *UserController) DeleteUserID(username string) (domain.User, error) {
...
func (_m *UserController) GetAllUsers() ([]domain.User, error) {
	ret := _m.Called()
...
func (_m *UserController) GetMyProfile(username string) (domain.User, error) {
	ret := _m.Called(username)
...
func (_m *UserController) GetUserByID(id string) (domain.User, error) {
	ret := _m.Called(id)
...
func (_m *UserController) LoginUser(username string, password string) (domain.User, error) {
...
func (_m *UserController) RegisterUser(user domain.User) error {
	ret := _m.Called(user)
