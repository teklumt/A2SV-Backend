...
func (_m *TaskController) CreateTask(task domain.Task) error {
	ret := _m.Called(task)
...
func (_m *TaskController) DeleteTask(id string) error {
	ret := _m.Called(id)
...
func (_m *TaskController) GetMyTasks(username string) ([]domain.Task, error) {
...
func (_m *TaskController) GetTaskByID(id string, creater string, Role_ string) (domain.Task, error) {
...
func (_m *TaskController) GetTasks() ([]domain.Task, error) {
	ret := _m.Called()
...
func (_m *TaskController) UpdateTask(id string, task domain.Task) error {
